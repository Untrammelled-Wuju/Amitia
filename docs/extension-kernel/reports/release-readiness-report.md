...
| 字段 | 值 |
|------|----|
| Report ID | final-acceptance-1785226921934900200 |
| 生成时间 | 2026-07-28T08:22:25Z |
| 开始时间 | 2026-07-28T08:22:01Z |
| 结束时间 | 2026-07-28T08:22:25Z |
| 总项 | 27 |
| 通过 | 25 |
| 失败 | 0 |
| 跳过 | 2 |
...
|---------|-------|-------|----------|--------|----------|
| stage1.freeze_audit | freeze_audit | 旧系统冻结与审计 | true | passed | GlobalLegacyCallCounter 实例化成功; 初始 Total()=0,跟踪指标数量=8; 旧系统调用计数器就绪 (冻结审计完成) |
