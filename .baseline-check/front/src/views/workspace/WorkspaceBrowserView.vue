...
async function stageAll(){if(!activeMount.value)return;await runGit(()=>gitPost('/api/workspaces/git/add',{workspaceUri:activeMount.value!.rootUri,paths:[],all:true,force:true}),'已暂存全部变更');}
