  ...
  <div class="section-card">
    ...
    <div class="gender-grid">
      ...
      <div class="gender-item">
        ...
        <el-select
          v-model="genderForm.pronoun"
          placeholder="选择代词"
          size="default"
          style="width: 100%"
          :disabled="genderForm.gender !== 'CUSTOM'"
        >
          <el-option
      ...
      <div class="gender-item" v-if="genderForm.gender === 'CUSTOM'">
        ...
        <el-input
          v-model="genderForm.genderLabel"
          placeholder='例如"伙伴""守护者"'
          size="default"
        />
      ...
      <div class="gender-item">
        ...
        <el-select
          v-model="genderForm.userAddressingStyle"
          placeholder="选择风格"
          size="default"
          style="width: 100%"
          clearable
        >
          <el-option
            v-for="opt in ADDRESSING_OPTIONS"
            :key="opt.value"
            :label="opt.label"
            :value="opt.value"
          />
      ...
      <div class="gender-item">
        ...
        <div class="sr-body">
          ...
          <div class="sr-slider-wrap">
            <el-slider
              v-model="genderForm.genderExpression"
              :min="0"
              :max="100"
              :step="1"
              class="sr-slider"
        ...
        <span class="gender-hint"
          >控制角色在语言风格、生活习惯中体现性别特征的强弱</span
        >
      </div>
    </div>
  </div>
