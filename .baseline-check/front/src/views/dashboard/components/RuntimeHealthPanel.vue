    ...
    <div class="health-module-grid">
      ...
      >
        ...
        <div class="hmi-body">
          ...
          <div class="hmi-status" :class="m.status">
            {{ healthStatusLabel(m.status) }}
          </div>
        </div>
