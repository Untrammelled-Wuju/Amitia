...
class AmitiaLayoutTokens extends ThemeExtension<AmitiaLayoutTokens> {
  const AmitiaLayoutTokens({
    ...
    this.tightGap = 8,
    this.listItemMinHeight = 56,
    this.listItemMaxHeight = 68,
...
class AmitiaTypographyTokens extends ThemeExtension<AmitiaTypographyTokens> {
  const AmitiaTypographyTokens({
    this.fontFamily,
    this.pageTitleSize = 20,
    this.pageLargeTitleSize = 24,
    this.sectionTitleSize = 17,
    this.cardTitleSize = 16,
    this.bodySize = 15,
    this.bodySmallSize = 14,
    this.captionSize = 13,
    this.labelSize = 12,
    this.statusLabelSize = 11,
    this.buttonSize = 15,
