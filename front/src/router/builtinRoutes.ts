...
{ path: "/character/:id/life-system", name: "characterLifeSystem", component: () => import("../views/character/CharacterView.vue"), meta: { requiresAuth: true } },
{ path: "/character/:id/debug", redirect: (to: any) => `/character/${to.params.id}/life-system` },
