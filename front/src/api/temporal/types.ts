...
export type TemporalTimezoneMode =
  ...
  | "follow_user"
  | "narrative";
export type TemporalAnchorTimeKind =
  | "instant"
  | "local_date"
  | "annual_date"
  | "local_datetime"
...
export type RelationshipTimeSensitivity =
  | "conservative"
  | "balanced"
  | "expressive";
export type ReunionKind =
  | "global_return"
  | "relationship_reconnect"
  | "reply_to_recent_proactive"
  | string;
export type ReunionLevel =
  | "none"
  | "noticeable"
  | "long"
  | "extended"
...
export interface TemporalDiagnostics {
  ...
  core: {
    featureFlags: {
      temporalCoreEnabled: boolean;
      relationshipTimeEnabled: boolean;
    };
    clockSource: string;
    tzdb: string;
  };
