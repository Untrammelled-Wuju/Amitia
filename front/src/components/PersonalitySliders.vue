...
<template>
  <div class="personality-sliders">
    <div class="ps-header">
      ...
      <el-button text size="small" type="primary" @click="resetToDefaults"
        >重置默认</el-button
      >
    </div>
...
} from "../views/character-config/composables/types";
...
const parsedModelValue =
  typeof props.modelValue === "string"
    ...
    : props.modelValue;
const model = reactive<PersonalityConfig>({
  ...DEFAULT_CONFIG,
  ...(parsedModelValue || {}),
});
