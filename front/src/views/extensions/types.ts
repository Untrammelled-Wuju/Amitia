...
export interface AgentSkillMCPDependency { id: string; description?: string; required: boolean; transport: "streamable_http" | "stdio" | ""; url?: string; command?: string; args?: string[]; authType: string; toolAllowlist?: string[]; defaultScope: "global" | "character"; autoConfigure?: boolean }
