        ...
        <div class="title-row">
          <nav aria-label="工作流页面层级">
            <ol class="builder-breadcrumb-list">
              <li><router-link class="breadcrumb-link" to="/extensions">扩展中心</router-link></li>
              <li class="breadcrumb-separator" aria-hidden="true">/</li>
              <li><router-link class="breadcrumb-link" to="/extensions/workflows">工作流</router-link></li>
              <li class="breadcrumb-separator" aria-hidden="true">/</li>
                  ...
                  <div v-if="selectedToolInputFields.length" class="tool-schema-form">
                    ...
                    <label v-for="field in selectedToolInputFields" :key="field.name" class="tool-schema-field">
                      ...
                      <el-input
                        ...
                        @change="(value: unknown) => setToolInputField(field, value)"
                      />
                    </label>
                  </div>
