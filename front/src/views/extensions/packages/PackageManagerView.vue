...
<style scoped>
.package-page { height: 100%; overflow: auto; color: var(--console-text); background: transparent; }
...
.panel { padding: 20px; border: 1px solid var(--console-border); border-radius: 14px; background: var(--ac-color-surface); box-shadow: none; }.import-panel { width: 100%; box-sizing: border-box; }.scope-row { justify-content: flex-start; margin-bottom: 18px; }.character-field { display: grid; grid-template-columns: auto minmax(220px, 320px); align-items: center; gap: 8px 12px; }.character-field label { color: var(--console-text-muted); font-size: 13px; }.character-field .el-select { width: 100%; }.field-error { grid-column: 2; color: var(--el-color-danger); font-size: 12px; }
