...
export function useMemoryEditor(
  ...
  function showEdit(row: any) {
    ...
    Object.assign(form, {
      ...
      scopeType: rowScopeType(row),
      source: row.source || "manual",
      sensitivity: rowSensitivity(row),
      allowContextUse: rowAllowContextUse(row),
      allowProactiveMention: rowAllowProactiveMention(row),
      requiresConfirmation: rowRequiresConfirmation(row),
    });
    dialogVisible.value = true;
  }
