...
<template>
  <div class="settings-layout">
    <div class="settings-tabs">
      ...
      <router-link to="/settings/deployment" class="settings-tab" active-class="settings-tab-active">部署模式</router-link>
      ...
      <router-link to="/settings/about" class="settings-tab" active-class="settings-tab-active">关于</router-link>
    </div>
...
.settings-tab:hover { color: var(--el-color-primary); }
.settings-tab-active {
