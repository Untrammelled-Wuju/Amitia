    ...
    <el-card shadow="never" class="section-card">
      ...
      <div class="preview-section">
        <div class="preview-row">
          ...
          <span class="preview-val">{{ themeState.accentColor || '默认' }}</span>
        </div>
        <div class="preview-row">
...
.preview-swatch { width: 24px; height: 24px; border-radius: 4px; border: 1px solid var(--ac-color-border); }
.preview-label { font-size: 13px; color: var(--ac-color-text-secondary); min-width: 64px; }
.preview-val { font-size: 13px; color: var(--ac-color-text-muted); }
</style>
