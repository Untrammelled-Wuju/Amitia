...
.ds-item { display: grid; grid-template-columns: 22px minmax(130px, 1fr) minmax(140px, 1.2fr); align-items: center; gap: 8px; min-height: 40px; padding: 8px 16px; border-top: 1px solid var(--console-border-soft); background: var(--ac-color-surface); font-size: 14px; }
