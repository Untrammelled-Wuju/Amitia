...
<template>
  <div class="page">
    ...
    <div class="call-area">
      ...
      <div
        class="call-visual"
        :class="{ active: connectionStatus === 'connected' }"
      >
...
const voiceList = [
  ...
  {
    name: "zh_female_xiaohe_jupiter_bigtts",
    label: "xiaohe - 甜美活泼女声(台湾口音)",
  },
  ...
  { name: "en_male_tim_uranus_bigtts", label: "Tim - 美式英语男声(O2.0)" },
  {
    ...
    label: "Dacey - 美式英语女声(O2.0)",
  },
  {
    name: "en_female_stokie_uranus_bigtts",
    label: "Stokie - 美式英语女声(O2.0)",
  },
];
...
const connectionStatus = ref<"idle" | "connecting" | "connected" | "error">(
  "idle",
);
...
async function startCall() {
  ...
  const wsUrl =
    ...
    "&voiceType=" +
    encodeURIComponent(config.voiceType) +
    "&resourceId=" +
    encodeURIComponent(config.resourceId);
...
.call-visual.active .r2 {
  animation-delay: 0.6s;
}
.call-visual.active .r3 {
