  ...
  <div class="section-card">
    ...
    <div class="work-grid">
      ...
      <div class="work-item">
        ...
        <el-time-picker
          v-model="workForm.workStartTime"
          format="HH:mm"
          value-format="HH:mm"
          size="default"
          style="width: 140px"
      ...
      <div class="work-item">
        ...
        <el-time-picker
          v-model="workForm.lunchBreakStartTime"
          format="HH:mm"
          value-format="HH:mm"
          size="default"
          style="width: 140px"
      ...
      <div class="work-item">
        ...
        <el-time-picker
          v-model="workForm.lunchBreakEndTime"
          format="HH:mm"
          value-format="HH:mm"
          size="default"
          style="width: 140px"
      ...
      <div class="work-item">
        ...
        <div style="display: flex; gap: 8px; align-items: center">
          <el-input-number
            v-model="workForm.commuteMinMinutes"
            :min="5"
            :max="90"
            size="default"
            style="width: 100px"
          />
          <span style="font-size: 11px; color: var(--ac-color-text-placeholder)"
            >到</span
          >
          <el-input-number
            v-model="workForm.commuteMaxMinutes"
            :min="5"
            :max="120"
            size="default"
            style="width: 100px"
      ...
      <div class="work-item">
        ...
        <div style="display: flex; gap: 8px; align-items: center">
          <el-input-number
            v-model="workForm.prepareMinMinutes"
            :min="10"
            :max="60"
            size="default"
            style="width: 100px"
          ...
          >
          <el-input-number
            v-model="workForm.prepareMaxMinutes"
            :min="10"
            :max="90"
            size="default"
            style="width: 100px"
      ...
      <div class="work-item">
        ...
        <el-select
          v-model="workForm.replyMode"
          size="default"
          style="width: 140px"
        >
          <el-option
            v-for="opt in WORK_REPLY_OPTIONS"
            :key="opt.value"
            :label="opt.label"
            :value="opt.value"
          />
      ...
      <div class="work-item" v-if="workForm.allowOvertime">
        ...
        <el-input-number
          v-model="workForm.overtimeProbability"
          :min="0"
          :max="100"
          size="default"
          style="width: 120px"
      ...
      <div class="work-item" v-if="workForm.allowOvertime">
        ...
        <div style="display: flex; gap: 8px; align-items: center">
          <el-input-number
            v-model="workForm.overtimeMinMinutes"
            :min="10"
            :max="120"
            size="default"
            style="width: 100px"
          ...
          >
          <el-input-number
            v-model="workForm.overtimeMaxMinutes"
            :min="10"
            :max="300"
            size="default"
            style="width: 100px"
      ...
      <div class="work-item" v-if="workForm.allowOvertime">
        ...
        <el-select
          v-model="workForm.overtimeReplyMode"
          size="default"
          style="width: 140px"
        >
          <el-option
      ...
      <div class="work-item" v-if="workForm.commuteHomeShareEnabled">
        ...
        <el-input-number
          v-model="workForm.commuteHomeShareProbability"
          :min="0"
          :max="100"
          size="default"
          style="width: 120px"
...
import {
  ...
  WEEKDAY_OPTIONS,
  WORK_REPLY_OPTIONS,
} from "../../../composables/useWorkProfile";
