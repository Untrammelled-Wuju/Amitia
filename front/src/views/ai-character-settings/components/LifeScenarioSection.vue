  ...
  <div class="section-card">
    ...
    <div class="gender-grid">
      <div class="gender-item">
        ...
        >
          <el-option
            v-for="opt in LIFE_IDENTITY_OPTIONS"
            :key="opt.value"
            :label="opt.label"
            :value="opt.value"
          />
      ...
      <div class="gender-item" v-if="isCustomLifeIdentity">
        ...
        <el-input
          v-model="lifeIdentityCustomModel"
          placeholder="例如：自由插画师、考研党、数字游民..."
          size="default"
        />
        <span class="gender-hint"
          >手动输入你的生活场景，角色会据此调整行为</span
        >
      </div>
    </div>
  </div>
...
const isCustomLifeIdentity = computed(
  () => !PRESET_IDENTITIES.includes(props.lifeIdentity),
);
