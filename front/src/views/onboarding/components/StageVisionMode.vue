        ...
        <div class="ob-model-page-card">
          ...
          <div class="ob-form-stack ob-model-page-fields" :class="{ 'ob-fields-disabled': visionMode === 'disabled' }">
            <label class="ob-input-label">接口地址
              <input
                :value="visionModelURL" :disabled="visionMode === 'disabled'"
            ...
            <label class="ob-input-label">API Key
              <div class="ob-input-password-wrap">
                <input :value="visionModelKey" :disabled="visionMode === 'disabled'" @input="emit('update:visionModelKey', ($event.target as HTMLInputElement).value)" :type="showVisionApiKey ? 'text' : 'password'" placeholder="火山引擎 API Key" />
            ...
            <label class="ob-input-label ob-model-page-wide">视觉模型
              ...
              <input
                :value="visionModelName" :disabled="visionMode === 'disabled'"
                @input="emit('update:visionModelName', ($event.target as HTMLInputElement).value)"
              />
                <button class="ob-small-action ob-detect-inline" @click="emit('detect')" :disabled="detecting || visionMode === 'disabled'">
