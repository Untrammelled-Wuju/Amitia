          ...
          <div v-if="visionMode !== 'disabled'" class="ob-form-stack ob-model-page-fields">
            ...
            <label class="ob-input-label">API Key
              <div class="ob-input-password-wrap">
                <input :value="visionModelKey" @input="emit('update:visionModelKey', ($event.target as HTMLInputElement).value)" :type="showVisionApiKey ? 'text' : 'password'" placeholder="火山引擎 API Key" />
