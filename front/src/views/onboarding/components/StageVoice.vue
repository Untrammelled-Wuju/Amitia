          ...
          <div v-if="voiceModelMode !== 'disabled'" class="ob-form-stack ob-voice-model-fields">
            ...
            <label class="ob-input-label">API Key
              <div class="ob-input-password-wrap">
                <input :value="voiceModelKey" @input="emit('update:voiceModelKey', ($event.target as HTMLInputElement).value)" :type="showVoiceApiKey ? 'text' : 'password'" placeholder="火山引擎 API Key" />
