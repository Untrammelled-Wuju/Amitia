...
func (h *Handler) Create(c *gin.Context) {
	var req CreateImageGenConfigRequest
	...
	util.SuccessMsgResponse(c, "生图模型配置已创建", cfg)
}
...
func (h *Handler) Update(c *gin.Context) {
	...
	util.SuccessMsgResponse(c, "生图模型配置已更新", cfg)
}
...
func (h *Handler) Delete(c *gin.Context) {
	...
	util.SuccessMsgResponse(c, "生图模型配置已删除", nil)
}
...
func (h *Handler) Activate(c *gin.Context) {
	...
	util.SuccessMsgResponse(c, "已设为默认生图模型", cfg)
}
