...
func (h *Handler) GetByConversation(c *gin.Context) { util.SuccessResponse(c, h.service.GetByConversation(c.Param("id"))) }
func (h *Handler) Delete(c *gin.Context) {
	id, _ := strconv.Atoi(c.Param("id"))
	if !h.service.Delete(id) { util.ErrorResponse(c, response.NotFound, "心情记录不存在", nil); return }
