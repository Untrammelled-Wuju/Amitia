...
func NewHandler(srv Service, db *gorm.DB, chatSvc chat.Service) *Handler {
	...
	h.versionInfo.Store(map[string]interface{}{"version": "1.0.0", "buildTime": "2026-05-27"})
	return h
}
...
func (h *Handler) ToolRoute(c *gin.Context)          { var body map[string]interface{}; c.ShouldBindJSON(&body); util.SuccessResponse(c, h.service.ToolRoute(body)) }
func (h *Handler) AppConfig(c *gin.Context)          { util.SuccessResponse(c, h.service.AppConfig()) }
func (h *Handler) UpdateConfig(c *gin.Context)       { var body map[string]interface{}; c.ShouldBindJSON(&body); util.SuccessResponse(c, h.service.UpdateAppConfig(body)) }
...
func (h *Handler) ConfigImportPreview(c *gin.Context) { var body map[string]interface{}; c.ShouldBindJSON(&body); util.SuccessResponse(c, h.service.ImportData(body)) }
func (h *Handler) ConfigImportConfirm(c *gin.Context) { var body map[string]interface{}; c.ShouldBindJSON(&body); util.SuccessResponse(c, h.service.ConfirmImports(body)) }
func (h *Handler) GetLLMConfig(c *gin.Context)       { util.SuccessResponse(c, h.service.GetLLMConfig()) }
func (h *Handler) UpdateLLMConfig(c *gin.Context)    { var body map[string]interface{}; c.ShouldBindJSON(&body); util.SuccessResponse(c, h.service.UpdateLLMConfig(body)) }
func (h *Handler) MoodDetectionConfig(c *gin.Context) { util.SuccessResponse(c, h.service.MoodDetectionConfig()) }
...
func (h *Handler) SetupStep(c *gin.Context)      { var body struct{ Step string `json:"step"` }; c.ShouldBindJSON(&body); util.SuccessResponse(c, h.service.SetupStep(body.Step)) }
func (h *Handler) OnboardingStatus(c *gin.Context) { util.SuccessResponse(c, h.service.OnboardingStatus()) }
func (h *Handler) OnboardingComplete(c *gin.Context) { util.SuccessResponse(c, h.service.OnboardingComplete()) }
func (h *Handler) OnboardingReset(c *gin.Context)  { util.SuccessResponse(c, h.service.OnboardingReset()) }

// ============= 主题 =============

func (h *Handler) GetTheme(c *gin.Context)    { util.SuccessResponse(c, h.service.GetTheme()) }
func (h *Handler) UpdateTheme(c *gin.Context) { var body map[string]interface{}; c.ShouldBindJSON(&body); util.SuccessResponse(c, h.service.UpdateTheme(body)) }
...
func (h *Handler) RecoveryCodesStatus(c *gin.Context) { util.SuccessResponse(c, h.service.GetRecoveryCodesStatus()) }
func (h *Handler) GenerateRecoveryCodes(c *gin.Context) { util.SuccessResponse(c, h.service.GenerateRecoveryCodes()) }
func (h *Handler) VerifyRecoveryCode(c *gin.Context) { var body struct{ Code string `json:"code"` }; c.ShouldBindJSON(&body); util.SuccessResponse(c, h.service.VerifyRecoveryCode(body.Code)) }
func (h *Handler) SessionSettings(c *gin.Context)  { util.SuccessResponse(c, h.service.GetSessionSettings()) }
func (h *Handler) UpdateSessionSettings(c *gin.Context) { var body map[string]interface{}; c.ShouldBindJSON(&body); util.SuccessResponse(c, h.service.UpdateSessionSettings(body)) }

// ============= 运行时 =============

func (h *Handler) RuntimeHealth(c *gin.Context)        { util.SuccessResponse(c, h.service.GetRuntimeHealth()) }
func (h *Handler) HealthHistory(c *gin.Context)         { util.SuccessResponse(c, h.service.GetRuntimeHealthHistory()) }
func (h *Handler) RuntimeStatus(c *gin.Context)         { util.SuccessResponse(c, h.service.GetRuntimeStatus()) }
func (h *Handler) CheckDBIntegrity(c *gin.Context)       { util.SuccessResponse(c, h.service.CheckDBIntegrity()) }
...
func (h *Handler) LongRunningConfig(c *gin.Context)     { util.SuccessResponse(c, h.service.GetLongRunningConfig()) }
func (h *Handler) UpdateLongRunningConfig(c *gin.Context) { var body map[string]interface{}; c.ShouldBindJSON(&body); util.SuccessResponse(c, h.service.UpdateLongRunningConfig(body)) }
func (h *Handler) LongRunningStatus(c *gin.Context)     { util.SuccessResponse(c, h.service.GetLongRunningStatus()) }
func (h *Handler) GetRuntimeMode(c *gin.Context)        { util.SuccessResponse(c, h.service.GetRuntimeMode()) }
func (h *Handler) UpdateRuntimeMode(c *gin.Context)     { var body map[string]interface{}; c.ShouldBindJSON(&body); util.SuccessResponse(c, h.service.UpdateRuntimeMode(body)) }

// ============= 审计 =============

func (h *Handler) AuditActions(c *gin.Context)          { util.SuccessResponse(c, h.service.GetAuditActions()) }
func (h *Handler) AuditSettings(c *gin.Context)         { util.SuccessResponse(c, h.service.GetAuditSettings()) }
func (h *Handler) UpdateAuditSettings(c *gin.Context)   { var body map[string]interface{}; c.ShouldBindJSON(&body); util.SuccessResponse(c, h.service.UpdateAuditSettings(body)) }
func (h *Handler) AuditStats(c *gin.Context)            { util.SuccessResponse(c, h.service.GetAuditStats()) }

// ============= 微信 =============

func (h *Handler) WechatBridgeStatus(c *gin.Context)       { util.SuccessResponse(c, h.service.GetWechatBridgeStatus()) }
func (h *Handler) WechatBridgeStatusDetail(c *gin.Context) { util.SuccessResponse(c, h.service.GetWechatBridgeStatusDetail()) }
func (h *Handler) WechatBridgeConfig(c *gin.Context)       { util.SuccessResponse(c, h.service.GetWechatBridgeConfig()) }
...
func (h *Handler) WechatCloudCheckReport(c *gin.Context)   { util.SuccessResponse(c, h.service.WechatCloudCheckReport()) }
func (h *Handler) WechatCloudCheckRiskSummary(c *gin.Context) { util.SuccessResponse(c, h.service.WechatCloudCheckRiskSummary()) }
func (h *Handler) WechatLoginReconnect(c *gin.Context)     { util.SuccessResponse(c, h.service.WechatLoginReconnect()) }
func (h *Handler) WechatLoginRescan(c *gin.Context)        { util.SuccessResponse(c, h.service.WechatLoginRescan()) }
func (h *Handler) WechatLoginStart(c *gin.Context)         { util.SuccessResponse(c, h.service.WechatLoginStart()) }
func (h *Handler) WechatLoginWait(c *gin.Context)          { util.SuccessResponse(c, h.service.WechatLoginWait()) }
...
func (h *Handler) WechatReplyTimingRecover(c *gin.Context) { util.SuccessResponse(c, h.service.WechatReplyTimingRecover()) }
func (h *Handler) WechatReplyTimingStatus(c *gin.Context)  { util.SuccessResponse(c, h.service.WechatReplyTimingStatus()) }

// ============= 通知 =============

func (h *Handler) NotificationsSettings(c *gin.Context)     { util.SuccessResponse(c, h.service.GetNotificationsSettings()) }
func (h *Handler) UpdateNotificationsSettings(c *gin.Context) { var body map[string]interface{}; c.ShouldBindJSON(&body); util.SuccessResponse(c, h.service.UpdateNotificationsSettings(body)) }
func (h *Handler) NotificationsStatus(c *gin.Context)       { util.SuccessResponse(c, h.service.GetNotificationsStatus()) }
func (h *Handler) NotificationsSubscribe(c *gin.Context)    { var body map[string]interface{}; c.ShouldBindJSON(&body); util.SuccessResponse(c, h.service.NotificationsSubscribe(body)) }
func (h *Handler) NotificationsTest(c *gin.Context)         { util.SuccessResponse(c, h.service.NotificationsTest()) }
func (h *Handler) NotificationsUnsubscribe(c *gin.Context)  { util.SuccessResponse(c, h.service.NotificationsUnsubscribe()) }

// ============= 安全配置 =============

func (h *Handler) SecurityAccessConfig(c *gin.Context)       { util.SuccessResponse(c, h.service.GetSecurityAccessConfig()) }
func (h *Handler) UpdateSecurityAccessConfig(c *gin.Context) { var body map[string]interface{}; c.ShouldBindJSON(&body); util.SuccessResponse(c, h.service.UpdateSecurityAccessConfig(body)) }
func (h *Handler) SecurityAccessStatus(c *gin.Context)       { util.SuccessResponse(c, h.service.GetSecurityAccessStatus()) }
func (h *Handler) SecurityAccountCheck(c *gin.Context)       { util.SuccessResponse(c, h.service.SecurityAccountCheck()) }
func (h *Handler) SecurityExposureCheck(c *gin.Context)      { util.SuccessResponse(c, h.service.SecurityExposureCheck()) }
func (h *Handler) SecurityStatus(c *gin.Context)             { util.SuccessResponse(c, h.service.GetSecurityStatus()) }
...
func (h *Handler) PrivacyScanResults(c *gin.Context)     { util.SuccessResponse(c, h.service.PrivacyScanResults()) }
func (h *Handler) PrivacyScanResultsGet(c *gin.Context)  { util.SuccessResponse(c, h.service.GetPrivacyScanResult(c.Param("id"))) }

// ============= 更新 =============

func (h *Handler) UpdateCheck(c *gin.Context)                 { util.SuccessResponse(c, h.service.CheckUpdate()) }
func (h *Handler) GetUpdateConfig(c *gin.Context)             { util.SuccessResponse(c, h.service.GetUpdateConfig()) }
func (h *Handler) UpdateConfig_Update(c *gin.Context)         { var body map[string]interface{}; c.ShouldBindJSON(&body); util.SuccessResponse(c, h.service.UpdateUpdateConfig(body)) }

// ============= 回复时序 =============

func (h *Handler) ReplyTimingOverview(c *gin.Context)     { util.SuccessResponse(c, h.service.GetReplyTimingOverview()) }
func (h *Handler) ReplyTimingBuffers(c *gin.Context)      { util.SuccessResponse(c, h.service.GetReplyTimingBuffers()) }
func (h *Handler) ReplyTimingForce(c *gin.Context)        { util.SuccessResponse(c, h.service.ReplyTimingForce()) }
func (h *Handler) ReplyTimingCancelBuffer(c *gin.Context)  { util.SuccessResponse(c, h.service.ReplyTimingCancelBuffer(c.Param("id"))) }
func (h *Handler) ReplyTimingForceBuffer(c *gin.Context)   { util.SuccessResponse(c, h.service.ReplyTimingForceBuffer(c.Param("id"))) }
func (h *Handler) ReplyTimingResumeBuffer(c *gin.Context)  { util.SuccessResponse(c, h.service.ReplyTimingResumeBuffer(c.Param("id"))) }

// ============= 存储 =============

func (h *Handler) StorageBackup(c *gin.Context)              { util.SuccessResponse(c, h.service.StorageBackup()) }
func (h *Handler) StorageBackupEncrypted(c *gin.Context)     { util.SuccessResponse(c, h.service.StorageBackupEncrypted()) }
func (h *Handler) StorageBackups(c *gin.Context)             { util.SuccessResponse(c, h.service.GetStorageBackups()) }
func (h *Handler) StorageDeleteBackup(c *gin.Context)        { util.SuccessResponse(c, h.service.DeleteStorageBackup(c.Param("name"))) }
func (h *Handler) StorageDeleteAll(c *gin.Context)           { util.SuccessResponse(c, h.service.DeleteAllStorage()) }
func (h *Handler) StorageRestore(c *gin.Context)             { util.SuccessResponse(c, h.service.StorageRestore(c.Param("name"))) }
func (h *Handler) StorageRestoreEncrypted(c *gin.Context)    { var body map[string]interface{}; c.ShouldBindJSON(&body); util.SuccessResponse(c, h.service.StorageRestoreEncrypted(body)) }
func (h *Handler) StorageRestoreVerify(c *gin.Context)       { var body map[string]interface{}; c.ShouldBindJSON(&body); util.SuccessResponse(c, h.service.StorageRestoreVerify(body)) }
func (h *Handler) StorageExportUserData(c *gin.Context)      { util.SuccessResponse(c, h.service.StorageExportUserData()) }
func (h *Handler) StorageImportUserData(c *gin.Context)      { var body map[string]interface{}; c.ShouldBindJSON(&body); util.SuccessResponse(c, h.service.StorageImportUserData(body)) }
func (h *Handler) StorageInfo(c *gin.Context)                { util.SuccessResponse(c, h.service.GetStorageInfo()) }
func (h *Handler) StorageMigrations(c *gin.Context)          { util.SuccessResponse(c, h.service.GetStorageMigrations()) }
func (h *Handler) StorageMigrationsCheck(c *gin.Context)     { util.SuccessResponse(c, h.service.CheckStorageMigrations()) }

// ============= 导入 =============

func (h *Handler) ImportsBatches(c *gin.Context)                    { util.SuccessResponse(c, h.service.GetImportsBatches()) }
func (h *Handler) ImportsBatchDetail(c *gin.Context)                { util.SuccessResponse(c, h.service.GetImportsBatchDetail(c.Param("id"))) }
func (h *Handler) ImportsBatchSummary(c *gin.Context)               { util.SuccessResponse(c, h.service.GetImportsBatchSummary(c.Param("id"))) }
func (h *Handler) ImportsBatchMemoryCandidates(c *gin.Context)      { util.SuccessResponse(c, h.service.GetImportsBatchMemoryCandidates(c.Param("id"))) }
func (h *Handler) ImportsBatchDelete(c *gin.Context)                { util.SuccessResponse(c, h.service.DeleteImportsBatch(c.Param("id"))) }
func (h *Handler) ImportsBatchGenerateSummary(c *gin.Context)       { util.SuccessResponse(c, h.service.GenerateImportsBatchSummary(c.Param("id"))) }
func (h *Handler) ImportsBatchConfirmMemories(c *gin.Context)       { util.SuccessResponse(c, h.service.ConfirmImportsBatchMemories(c.Param("id"))) }
func (h *Handler) ImportsUpload(c *gin.Context)                     { var body map[string]interface{}; c.ShouldBindJSON(&body); util.SuccessResponse(c, h.service.UploadImports(body)) }
func (h *Handler) ImportsParseText(c *gin.Context)                  { var body map[string]interface{}; c.ShouldBindJSON(&body); util.SuccessResponse(c, h.service.ParseImportsText(body)) }
func (h *Handler) ImportsConfirm(c *gin.Context)                    { var body map[string]interface{}; c.ShouldBindJSON(&body); util.SuccessResponse(c, h.service.ConfirmImports(body)) }
func (h *Handler) ImportData(c *gin.Context)                        { var body map[string]interface{}; c.ShouldBindJSON(&body); util.SuccessResponse(c, h.service.ImportData(body)) }

// ============= 用量 =============

func (h *Handler) UsageOverview(c *gin.Context) { util.SuccessResponse(c, h.service.GetUsageOverview()) }
...
func (h *Handler) LogsRecentErrors(c *gin.Context)  { util.SuccessResponse(c, h.service.GetLogsRecentErrors(20)) }
func (h *Handler) LogsFiles(c *gin.Context)         { util.SuccessResponse(c, h.service.GetLogsFiles()) }
func (h *Handler) LogsFileContent(c *gin.Context)   { c.String(200, h.service.GetLogsFileContent(c.Param("name"))) }
func (h *Handler) LogsDelete(c *gin.Context)        { util.SuccessResponse(c, h.service.DeleteLogs()) }
func (h *Handler) LogsModelErrors(c *gin.Context)   { util.SuccessResponse(c, h.service.GetLogsModelErrors()) }
func (h *Handler) LogsDeleteModelErrors(c *gin.Context) { util.SuccessResponse(c, h.service.DeleteLogsModelErrors()) }

// ============= 维护 =============

func (h *Handler) MaintenanceStatus(c *gin.Context)             { util.SuccessResponse(c, h.service.GetMaintenanceStatus()) }
func (h *Handler) MaintenanceDiagnose(c *gin.Context)           { util.SuccessResponse(c, h.service.MaintenanceDiagnose()) }
func (h *Handler) MaintenanceExportDiagnostic(c *gin.Context)   { util.SuccessResponse(c, h.service.MaintenanceExportDiagnostic()) }
func (h *Handler) MaintenanceReloadConfig(c *gin.Context)       { util.SuccessResponse(c, h.service.MaintenanceReloadConfig()) }
func (h *Handler) MaintenanceRestartBridge(c *gin.Context)      { util.SuccessResponse(c, h.service.MaintenanceRestartBridge()) }

// ============= 版本 =============

func (h *Handler) ReleaseCheckLatest(c *gin.Context)   { util.SuccessResponse(c, h.service.GetReleaseCheckLatest()) }
func (h *Handler) ReleaseCheckHistory(c *gin.Context)  { util.SuccessResponse(c, h.service.GetReleaseCheckHistory()) }
func (h *Handler) ReleaseCheckExport(c *gin.Context)   { util.SuccessResponse(c, h.service.ExportReleaseCheck()) }
func (h *Handler) ReleaseCheckRun(c *gin.Context)      { util.SuccessResponse(c, h.service.RunReleaseCheck()) }

// ============= 心情 =============

func (h *Handler) GetCompanionMoods(c *gin.Context)               { util.SuccessResponse(c, h.service.GetMoods()) }
func (h *Handler) GetCompanionMoodsByConversation(c *gin.Context) { util.SuccessResponse(c, h.service.GetMoodsByConversation(c.Param("id"))) }
func (h *Handler) DeleteCompanionMood(c *gin.Context)             { util.SuccessResponse(c, h.service.DeleteMood(c.Param("id"))) }
func (h *Handler) DeleteCompanionMoodsByConversation(c *gin.Context) { util.SuccessResponse(c, h.service.DeleteMoodsByConversation(c.Param("id"))) }
...
func (h *Handler) WebChatRegenerate(c *gin.Context) {
	convID := c.Param("id")
	if convID == "" { util.ErrorResponse(c, response.InvalidParams, "缺少会话ID", nil); return }
	type lastMsg struct{ Role string; Content string }; var msg lastMsg
	if err := h.db.Table("messages").Select("role, content").Where("conversation_id = ?", convID).Order("created_at DESC").Limit(1).Row().Scan(&msg.Role, &msg.Content); err != nil || msg.Role != "user" {
		util.ErrorResponse(c, response.DataNotFound, "没有可重新生成的消息", nil); return
	}
...
func (h *Handler) getDBPath() string {
	...
	if dbPath == "" { dbPath = filepath.Join("data", "app.db") }
	return dbPath
}
...
func (h *Handler) readLogTail(path string, limit int) []map[string]interface{} {
	...
	for i := start; i < len(lines); i++ {
		...
		if strings.Contains(line, "error") { entry["level"] = "error" } else if strings.Contains(line, "warn") { entry["level"] = "warn" } else { entry["level"] = "info" }
