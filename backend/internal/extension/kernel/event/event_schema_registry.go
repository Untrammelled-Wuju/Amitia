...
func DefaultHostEventTypes() []EventTypeDefinition {
	...
	return []EventTypeDefinition{
		...
		{
			EventTypeID: "workflow.installation.created", Version: 1,
			Description:     "Workflow installation created",
			MaxPayloadBytes: maxPayload, MaxMetadataBytes: maxMeta,
			RiskLevel:        RiskLevelLow,
			ProducerPolicy:   EventProducerPolicy{AllowedProducers: []string{"host", "system"}, RequireSystemTrust: true, MaxPayloadBytes: maxPayload, MaxMetadataBytes: maxMeta},
			SubscriberPolicy: EventSubscriberPolicy{AllowThirdParty: false, MaxSubscribers: 16, RequireApproval: true},
			DeliveryPolicy:   EventDeliveryPolicy{Timeout: 5e9, MaxAttempts: 5, InitialBackoff: 1e9, MaxBackoff: 3e8, BackoffMultiplier: 2, JitterFactor: 0.2, OrderingRequirement: OrderingPerPartition, MaxInFlight: 4},
			OrderingPolicy:   OrderingPerPartition,
		},
		{
			EventTypeID: "workflow.installation.updated", Version: 1,
			Description:     "Workflow installation updated",
			MaxPayloadBytes: maxPayload, MaxMetadataBytes: maxMeta,
			RiskLevel:        RiskLevelLow,
			ProducerPolicy:   EventProducerPolicy{AllowedProducers: []string{"host", "system"}, RequireSystemTrust: true, MaxPayloadBytes: maxPayload, MaxMetadataBytes: maxMeta},
			SubscriberPolicy: EventSubscriberPolicy{AllowThirdParty: false, MaxSubscribers: 16, RequireApproval: true},
		...
		{
			EventTypeID: "workflow.installation.deleted", Version: 1,
			Description:     "Workflow installation deleted",
			MaxPayloadBytes: maxPayload, MaxMetadataBytes: maxMeta,
			RiskLevel:        RiskLevelLow,
			ProducerPolicy:   EventProducerPolicy{AllowedProducers: []string{"host", "system"}, RequireSystemTrust: true, MaxPayloadBytes: maxPayload, MaxMetadataBytes: maxMeta},
			SubscriberPolicy: EventSubscriberPolicy{AllowThirdParty: false, MaxSubscribers: 16, RequireApproval: true},
		...
		{
			EventTypeID: "workflow.installation.enabled", Version: 1,
			Description:     "Workflow installation enabled",
			MaxPayloadBytes: maxPayload, MaxMetadataBytes: maxMeta,
			RiskLevel:        RiskLevelLow,
			ProducerPolicy:   EventProducerPolicy{AllowedProducers: []string{"host", "system"}, RequireSystemTrust: true, MaxPayloadBytes: maxPayload, MaxMetadataBytes: maxMeta},
			SubscriberPolicy: EventSubscriberPolicy{AllowThirdParty: false, MaxSubscribers: 16, RequireApproval: true},
		...
		{
			EventTypeID: "workflow.installation.disabled", Version: 1,
			Description:     "Workflow installation disabled",
			MaxPayloadBytes: maxPayload, MaxMetadataBytes: maxMeta,
			RiskLevel:        RiskLevelLow,
			ProducerPolicy:   EventProducerPolicy{AllowedProducers: []string{"host", "system"}, RequireSystemTrust: true, MaxPayloadBytes: maxPayload, MaxMetadataBytes: maxMeta},
			SubscriberPolicy: EventSubscriberPolicy{AllowThirdParty: false, MaxSubscribers: 16, RequireApproval: true},
		...
		{
			EventTypeID: "workflow.run.started", Version: 1,
		...
		{
			EventTypeID: "workflow.run.updated", Version: 1,
			Description:     "Workflow run state updated",
			MaxPayloadBytes: maxPayload, MaxMetadataBytes: maxMeta,
			RiskLevel:        RiskLevelLow,
			ProducerPolicy:   EventProducerPolicy{AllowedProducers: []string{"host", "system"}, RequireSystemTrust: true, MaxPayloadBytes: maxPayload, MaxMetadataBytes: maxMeta},
			SubscriberPolicy: EventSubscriberPolicy{AllowThirdParty: false, MaxSubscribers: 16, RequireApproval: true},
		...
		{
			EventTypeID: "workflow.run.finished", Version: 1,
			Description:     "Workflow run finished",
			MaxPayloadBytes: maxPayload, MaxMetadataBytes: maxMeta,
			RiskLevel:        RiskLevelLow,
			ProducerPolicy:   EventProducerPolicy{AllowedProducers: []string{"host", "system"}, RequireSystemTrust: true, MaxPayloadBytes: maxPayload, MaxMetadataBytes: maxMeta},
			SubscriberPolicy: EventSubscriberPolicy{AllowThirdParty: false, MaxSubscribers: 16, RequireApproval: true},
