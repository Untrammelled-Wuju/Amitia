...
var (
	ErrInvalidManifest         = errors.New("manifest_v1: invalid manifest")
	ErrUnsupportedVersion      = errors.New("manifest_v1: unsupported manifest version")
	ErrMissingField            = errors.New("manifest_v1: missing required field")
	ErrInvalidExtensionID      = errors.New("manifest_v1: invalid extension id")
	ErrInvalidVersion          = errors.New("manifest_v1: invalid version")
	ErrDuplicateModule         = errors.New("manifest_v1: duplicate module id")
	ErrDuplicateContribution   = errors.New("manifest_v1: duplicate contribution id")
	ErrUnknownModuleType       = errors.New("manifest_v1: unknown module type")
	ErrUnknownContributionKind = errors.New("manifest_v1: unknown contribution kind")
)
