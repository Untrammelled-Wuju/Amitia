...
func buildIOSToolDefinitions() []capability.ToolDefinition {
	...
	defs := []capability.ToolDefinition{
		...
		makeIOSNativeTool(rt, homekit.ToolIDScenesCreate, homekit.ModelNameHomeKit, homekit.OperationScenesCreate, "Create HomeKit Scene", "Create a scene", genericInput, genericOutput, []capability.PermissionRequirement{{Capability: "ios.homekit.write", Risk: "medium"}}, capability.RiskMedium, true),
		makeIOSNativeTool(rt, homekit.ToolIDScenesUpdate, homekit.ModelNameHomeKit, homekit.OperationScenesUpdate, "Update HomeKit Scene", "Update a scene", genericInput, genericOutput, []capability.PermissionRequirement{{Capability: "ios.homekit.write", Risk: "medium"}}, capability.RiskMedium, true),
		makeIOSNativeTool(rt, homekit.ToolIDScenesDelete, homekit.ModelNameHomeKit, homekit.OperationScenesDelete, "Delete HomeKit Scene", "Delete a scene", genericInput, genericOutput, []capability.PermissionRequirement{{Capability: "ios.homekit.write", Risk: "medium"}}, capability.RiskMedium, true),
		...
		makeIOSNativeTool(rt, homekit.ToolIDAutomationsGet, homekit.ModelNameHomeKit, homekit.OperationAutomationsGet, "Get HomeKit Automation", "Get an automation", genericInput, genericOutput, []capability.PermissionRequirement{{Capability: "ios.homekit.read", Risk: "low"}}, capability.RiskLow, false),
		makeIOSNativeTool(rt, homekit.ToolIDAutomationsCreate, homekit.ModelNameHomeKit, homekit.OperationAutomationsCreate, "Create HomeKit Automation", "Create an automation", genericInput, genericOutput, []capability.PermissionRequirement{{Capability: "ios.homekit.write", Risk: "medium"}}, capability.RiskMedium, true),
		makeIOSNativeTool(rt, homekit.ToolIDAutomationsUpdate, homekit.ModelNameHomeKit, homekit.OperationAutomationsUpdate, "Update HomeKit Automation", "Update an automation", genericInput, genericOutput, []capability.PermissionRequirement{{Capability: "ios.homekit.write", Risk: "medium"}}, capability.RiskMedium, true),
		makeIOSNativeTool(rt, homekit.ToolIDAutomationsEnable, homekit.ModelNameHomeKit, homekit.OperationAutomationsEnable, "Enable HomeKit Automation", "Enable an automation", genericInput, genericOutput, []capability.PermissionRequirement{{Capability: "ios.homekit.write", Risk: "medium"}}, capability.RiskMedium, true),
		makeIOSNativeTool(rt, homekit.ToolIDAutomationsDelete, homekit.ModelNameHomeKit, homekit.OperationAutomationsDelete, "Delete HomeKit Automation", "Delete an automation", genericInput, genericOutput, []capability.PermissionRequirement{{Capability: "ios.homekit.write", Risk: "medium"}}, capability.RiskMedium, true),
		makeIOSNativeTool(rt, homekit.ToolIDSetupPresent, homekit.ModelNameHomeKit, homekit.OperationSetupPresent, "Present HomeKit Setup", "Present HomeKit setup UI", genericInput, genericOutput, []capability.PermissionRequirement{{Capability: "ios.homekit.write", Risk: "medium"}}, capability.RiskMedium, true),
		makeIOSNativeTool(rt, homekit.ToolIDEnableHomeKit, homekit.ModelNameHomeKit, homekit.OperationEnableHomeKit, "Enable HomeKit", "Enable HomeKit integration", genericInput, genericOutput, []capability.PermissionRequirement{{Capability: "ios.homekit.write", Risk: "medium"}}, capability.RiskMedium, true),
		...
		makeIOSNativeTool(rt, shortcuts.ToolIDIntentRegister, "", shortcuts.OperationIntentRegister, "Register Shortcut Intent", "Register a shortcut intent", genericInput, genericOutput, []capability.PermissionRequirement{{Capability: "ios.shortcuts.execute", Risk: "high"}}, capability.RiskHigh, true),
		makeIOSNativeTool(rt, shortcuts.ToolIDIntentRevoke, "", shortcuts.OperationIntentRevoke, "Revoke Shortcut Intent", "Revoke a shortcut intent", genericInput, genericOutput, []capability.PermissionRequirement{{Capability: "ios.shortcuts.execute", Risk: "high"}}, capability.RiskHigh, true),
		makeIOSNativeTool(rt, shortcuts.ToolIDIntentDonate, "", shortcuts.OperationIntentDonate, "Donate Shortcut Intent", "Donate a shortcut intent", genericInput, genericOutput, []capability.PermissionRequirement{{Capability: "ios.shortcuts.execute", Risk: "high"}}, capability.RiskHigh, true),
		...
		makeIOSNativeTool(rt, shortcuts.ToolIDShortcutsUpdate, "", shortcuts.OperationShortcutsUpdate, "Update Shortcuts", "Update shortcuts", genericInput, genericOutput, []capability.PermissionRequirement{{Capability: "ios.shortcuts.execute", Risk: "high"}}, capability.RiskHigh, true),
