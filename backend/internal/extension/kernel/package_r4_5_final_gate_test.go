...
func TestR45FinalGateRejectsFutureIssuedAt(t *testing.T) {
	...
	op := PackageOperationRecord{OperationID: "op-fg-1", OperationType: "install", ExtensionID: "ext-finalgate", SpaceID: "user-finalgate"}
...
func TestR45FinalGateRejectsExpiresEqualIssued(t *testing.T) {
	...
	op := PackageOperationRecord{OperationID: "op-fg-2", OperationType: "install", ExtensionID: "ext-finalgate", SpaceID: "user-finalgate"}
	if err := r.verifyPackageClaimsBinding(context.Background(), op, claims); err == nil {
...
func TestR45FinalGateRejectsExpiresBeforeIssued(t *testing.T) {
	...
	op := PackageOperationRecord{OperationID: "op-fg-3", OperationType: "install", ExtensionID: "ext-finalgate", SpaceID: "user-finalgate"}
	if err := r.verifyPackageClaimsBinding(context.Background(), op, claims); err == nil {
...
func TestR45FinalGateRejectsCurrentExpiredClaims(t *testing.T) {
	...
	op := PackageOperationRecord{OperationID: "op-fg-4", OperationType: "install", ExtensionID: "ext-finalgate", SpaceID: "user-finalgate"}
	if err := r.verifyPackageClaimsBinding(context.Background(), op, claims); err == nil {
...
func TestR45FinalGateRejectsCurrentSecurityPolicyDrift(t *testing.T) {
	...
	op := PackageOperationRecord{OperationID: "op-fg-5", OperationType: "install", ExtensionID: "ext-finalgate", SpaceID: "user-finalgate"}
	if err := r.verifyPackageClaimsBinding(context.Background(), op, claims); err == nil {
...
func TestR45FinalGateRejectsMissingNonceBinding(t *testing.T) {
	...
	op := PackageOperationRecord{OperationID: "op-fg-6", OperationType: "install", ExtensionID: "ext-finalgate", SpaceID: "user-finalgate"}
	if err := r.verifyPackageClaimsBinding(context.Background(), op, claims); err == nil {
...
func TestR45FinalGateRejectsEmptyRequiredConfirmationsHash(t *testing.T) {
	...
	op := PackageOperationRecord{OperationID: "op-fg-7", OperationType: "install", ExtensionID: "ext-finalgate", SpaceID: "user-finalgate"}
	if err := r.verifyPackageClaimsBinding(context.Background(), op, claims); err == nil {
...
func TestR45FinalGateRejectsEmptyDependenciesHash(t *testing.T) {
	...
	op := PackageOperationRecord{OperationID: "op-fg-8", OperationType: "install", ExtensionID: "ext-finalgate", SpaceID: "user-finalgate"}
	if err := r.verifyPackageClaimsBinding(context.Background(), op, claims); err == nil {
...
func TestR45RuntimeNilContainerRejectsBinding(t *testing.T) {
	r := &Runtime{}
	claims := r45ValidClaimsTemplate()
	op := PackageOperationRecord{OperationID: "op-fg-9", OperationType: "install", ExtensionID: "ext-finalgate", SpaceID: "user-finalgate"}
	if err := r.verifyPackageClaimsBinding(context.Background(), op, claims); err == nil {
