...
func (r *PermissionDefinitionRegistry) registerBuiltin() {
	builtins := []PermissionDefinition{
		...
		{ID: "message.send", Name: "Send Message", Description: "Send message to user", Category: CategoryHostData, RiskLevel: capability.RiskMedium, AllowedScopes: []ScopeType{ScopeGlobal, ScopeCharacter, ScopeConversation, ScopeExtension, ScopeModule}, PersistentGrantable: true, BackgroundAllowed: true, ChildInvocation: ChildReevaluate, DefaultApproval: ApprovalManual},
		{ID: "message.append", Name: "Append Message", Description: "Append explicit text or media messages to a conversation", Category: CategoryHostData, RiskLevel: capability.RiskHigh, AllowedScopes: []ScopeType{ScopeGlobal, ScopeCharacter, ScopeConversation, ScopeExtension, ScopeModule}, PersistentGrantable: false, RequiresPerUse: true, BackgroundAllowed: true, ChildInvocation: ChildReevaluate, DefaultApproval: ApprovalManual},
		{ID: "vector.read", Name: "Search Vectors", Description: "Search vectors in the current extension namespace", Category: CategoryHostData, RiskLevel: capability.RiskLow, AllowedScopes: []ScopeType{ScopeGlobal, ScopeExtension, ScopeModule}, PersistentGrantable: true, BackgroundAllowed: true, ChildInvocation: ChildInherit, DefaultApproval: ApprovalAuto},
		{ID: "vector.write", Name: "Write Vectors", Description: "Create or delete vectors in the current extension namespace", Category: CategoryHostData, RiskLevel: capability.RiskMedium, AllowedScopes: []ScopeType{ScopeGlobal, ScopeExtension, ScopeModule}, PersistentGrantable: true, BackgroundAllowed: true, ChildInvocation: ChildReevaluate, DefaultApproval: ApprovalManual},
		...
		{ID: "service.files.space_resource", Name: "Access Space Resource", Description: "Access space-owned resources through the service runtime", Category: CategoryService, RiskLevel: capability.RiskHigh, AllowedScopes: []ScopeType{ScopeExtension, ScopeModule, ScopeGlobal}, PersistentGrantable: false, RequiresPerUse: true, BackgroundAllowed: false, ChildInvocation: ChildDeny, TrustedOnly: true, DefaultApproval: ApprovalManual},
