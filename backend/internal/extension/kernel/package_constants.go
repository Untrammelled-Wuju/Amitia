...
const (
	StepValidatePreviewSession        = "validate_preview_session"
	StepReverifyArtifactHash          = "reverify_artifact_hash"
	StepExtractToStaging              = "extract_to_staging"
	StepBuildCandidateDefinitions     = "build_candidate_definitions"
	StepCreateRollbackPoint           = "create_rollback_point"
	StepCommitInstalledTree           = "commit_installed_tree"
	StepCommitTargetGeneration        = "commit_target_generation"
	StepSwitchCurrentPointer          = "switch_current_pointer"
	StepCommitKernelRepositories      = "commit_kernel_repositories"
	StepCommitUpdateState             = "commit_update_state"
	StepMarkInstallationDisabled      = "mark_installation_disabled"
	StepExecuteMigrations             = "execute_migrations"
	StepValidateAndDiff               = "validate_and_diff"
