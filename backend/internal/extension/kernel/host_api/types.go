...
const (
	...
	MethodResourceLink              Method = "host.resource.link"
	MethodResourceDelete            Method = "host.resource.delete"
	...
	MethodCharacterList             Method = "host.character.list"
	MethodConversationRead          Method = "host.conversation.read"
	MethodConversationMessageSend   Method = "host.conversation.message.send"
	MethodConversationMessageAppend Method = "host.conversation.message.append"
	MethodMemoryQuery               Method = "host.memory.query"
	MethodProviderInvoke            Method = "host.provider.invoke"
	MethodExtensionDataRead         Method = "host.extension.data.read"
	MethodVectorUpsert              Method = "host.vector.upsert"
	MethodVectorSearch              Method = "host.vector.search"
	MethodVectorDelete              Method = "host.vector.delete"
	...
	MethodNetworkTCPRead            Method = "host.network.tcp.read"
	MethodNetworkTCPWrite           Method = "host.network.tcp.write"
	MethodNetworkTCPClose           Method = "host.network.tcp.close"
	MethodNetworkUDPOpen            Method = "host.network.udp.open"
	MethodNetworkUDPReceive         Method = "host.network.udp.receive"
	MethodNetworkUDPSend            Method = "host.network.udp.send"
	MethodNetworkUDPClose           Method = "host.network.udp.close"
	MethodNetworkWebSocketOpen      Method = "host.network.websocket.open"
	MethodNetworkWebSocketReceive   Method = "host.network.websocket.receive"
	MethodNetworkWebSocketSend      Method = "host.network.websocket.send"
	MethodNetworkWebSocketClose     Method = "host.network.websocket.close"
