...
var schemaMigrations = []string{
	...
	`CREATE TABLE IF NOT EXISTS extension_task_runs (
		...
		execution_resolved_at DATETIME,
		execution_resolved_by TEXT NOT NULL DEFAULT '',
...
var schemaColumnAdditions = []columnAddition{
	...
	{"kernel_host_registry", "runtime_id", "TEXT NOT NULL DEFAULT ''"},
	{"kernel_host_registry", "entry_kind", "TEXT NOT NULL DEFAULT 'ui_host'"},
	{"kernel_host_registry", "host_session_id", "TEXT NOT NULL DEFAULT ''"},
}
