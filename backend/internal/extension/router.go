...
func RegisterRouter(group *gin.RouterGroup, ctx *app.AppContext, runtime *Runtime) {
	...
	extensions.GET("/packages/import/sessions/:sessionId", retiredLegacyPackageEndpoint)
	extensions.POST("/packages/import/install", retiredPackageInstallEndpoint)
	extensions.DELETE("/packages/import/sessions/:sessionId", retiredLegacyPackageEndpoint)
	extensions.GET("/packages/metrics", retiredLegacyPackageEndpoint)
	extensions.GET("/package-operations", retiredLegacyPackageEndpoint)
	extensions.GET("/package-operations/:operationId", retiredLegacyPackageEndpoint)
	extensions.GET("/package-operations/:operationId/final-gate", retiredLegacyPackageEndpoint)
	extensions.GET("/signers", retiredLegacyPackageEndpoint)
	extensions.POST("/signers/:fingerprint/trust", retiredLegacyPackageEndpoint)
	extensions.POST("/signers/:fingerprint/untrust", retiredLegacyPackageEndpoint)
	extensions.GET("/:id/exports/:exportId", retiredLegacyPackageEndpoint)
	extensions.POST("/:id/export", retiredLegacyPackageEndpoint)
	extensions.POST("/:id/upgrade/preview", retiredPackagePreviewEndpoint)
	extensions.POST("/:id/upgrade", retiredPackageInstallEndpoint)
	extensions.GET("/:id/versions", retiredLegacyPackageEndpoint)
	extensions.GET("/:id/versions/compare", retiredLegacyPackageEndpoint)
	extensions.POST("/:id/versions/:version/rollback", retiredLegacyPackageEndpoint)
	extensions.GET("/:id/versions/:version/rollback/preview", retiredLegacyPackageEndpoint)
	extensions.POST("/:id/versions/:version/rollback/preview", retiredLegacyPackageEndpoint)
	extensions.GET("/:id/dependencies", retiredLegacyPackageEndpoint)
	extensions.GET("/:id/uninstall/preview", retiredLegacyPackageEndpoint)
	extensions.POST("/:id/uninstall/preview", retiredLegacyPackageEndpoint)
	extensions.POST("/:id/uninstall", retiredLegacyPackageEndpoint)
	extensions.DELETE("/:id", retiredLegacyPackageEndpoint)
	group.GET("/extension-package-operations/:operationId", extensionAuth(userService), retiredLegacyPackageEndpoint)
	group.GET("/extension-package-operations/:operationId/final-gate", extensionAuth(userService), retiredLegacyPackageEndpoint)
