...
func RegisterRouter(group *gin.RouterGroup, ctx *app.AppContext, runtime *Runtime) {
	...
	extensions.POST("/packages/import/preview", retiredPackagePreviewEndpoint)
	extensions.GET("/packages/import/sessions/:sessionId", packageHandler.Session)
	extensions.POST("/packages/import/install", retiredPackageInstallEndpoint)
	extensions.DELETE("/packages/import/sessions/:sessionId", packageHandler.CancelSession)
	...
	extensions.GET("/package-operations/:operationId/final-gate", packageHandler.VerifyFinalGate)
	...
	extensions.POST("/:id/upgrade/preview", retiredPackagePreviewEndpoint)
	extensions.POST("/:id/upgrade", retiredPackageInstallEndpoint)
	...
	extensions.GET("/:id/versions/:version/rollback/preview", packageHandler.PreviewRollback)
	extensions.POST("/:id/versions/:version/rollback/preview", packageHandler.PreviewRollback)
	...
	extensions.POST("/:id/uninstall/preview", packageHandler.PreviewUninstall)
	extensions.POST("/:id/uninstall", packageHandler.Uninstall)
	extensions.DELETE("/:id", packageHandler.Uninstall)
	group.GET("/extension-package-operations/:operationId", extensionAuth(userService), packageHandler.Operation)
	group.GET("/extension-package-operations/:operationId/final-gate", extensionAuth(userService), packageHandler.VerifyFinalGate)
