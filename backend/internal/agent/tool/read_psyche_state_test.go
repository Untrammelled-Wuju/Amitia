...
func TestReadPsycheStateWithBeliefs(t *testing.T) {
	...
	if _, err := toolDB.Exec("INSERT INTO resolved_beliefs (character_id, key, value, confidence, created_at) VALUES (?, ?, ?, ?, ?)", "char-belief", "self-worth", "觉得自己不够好", 0.85, "2026-07-05 08:00:00"); err != nil {
		t.Fatal(err)
	}
