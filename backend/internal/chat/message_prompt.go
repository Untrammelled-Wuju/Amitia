...
type processPromptInput struct {
	...
	StyleInstruction, TemporalContext, ContinuityContext, ProactiveScene, ProactiveTimeContext, ProactiveRecentContext, ProactivePersonality, ProactiveRelationship, ProactiveEmotion, ProactiveMemory, CharacterBase, ProactiveTaskInstruction, UserContent string
...
func buildProcessPromptMessages(input processPromptInput) ([]map[string]interface{}, *promptir.PromptTrace) {
	...
	if err != nil {
		...
		request.ProfileContext, request.TemporalContext, request.ContinuityContext, request.MemoryContext, request.Worldbook, request.PluginContext, request.AgentSkillContext, request.History, request.ProactiveScene, request.ProactiveTimeContext, request.ProactiveRecentContext = "", "", "", "", "", "", "", "", "", "", ""
		gwMessages, promptTrace, err = gateway.BuildMessages(request)
		if err != nil {
