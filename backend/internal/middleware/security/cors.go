...
func CorsMiddleware(cfg CorsConfig) gin.HandlerFunc {
	...
	if len(cfg.AllowedHeaders) == 0 {
		cfg.AllowedHeaders = []string{"Content-Type", "Authorization", "X-Device-Timezone", "X-Amitia-Local-Token", "X-Amitia-Desktop-Session", "X-Amitia-Desktop-Instance", "X-Amitia-Device-ID", "X-Amitia-Client-Type", "X-Request-ID"}
	}
	if cfg.MaxAge == 0 {
		cfg.MaxAge = 86400
	}
