...
type V1ActivePetAdapter struct {
...
func NewV1ActivePetAdapter(installRepo installation.Repository, facade *runtimev1.RuntimeFacade, dataDir string) *V1ActivePetAdapter {
	return &V1ActivePetAdapter{
...
func (a *V1ActivePetAdapter) resolveActivePet(ctx context.Context, userID, characterID, installationHint, petInstanceHint string) (*behavior.ActivePetSnapshot, error) {
	...
	if err != nil {
		log.Logger.Warnf("wiring/active_pet_v1_port: failed to read manifest installationId=%s err=%v", selected.ID, err)
	}
...
var _ behavior.ActivePetPort = (*V1ActivePetAdapter)(nil)
var _ behavior.EventTargetedActivePetPort = (*V1ActivePetAdapter)(nil)
