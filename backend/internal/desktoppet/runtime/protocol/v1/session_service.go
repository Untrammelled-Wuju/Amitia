// Package v1 provides the DesktopPet runtime protocol v1 implementation.
//
...
// for DesktopPet v1 runtime protocol. Production code MUST:
...
// CreateSession is a DEPRECATED compatibility path for DesktopPet v1 session creation.
...
// AcquireSession is a DEPRECATED compatibility path for DesktopPet v1 session re-acquisition.
