...
func (ActiveActionRevisionBinding) TableName() string {
	return "desktop_pet_active_action_revision_bindings"
}
...
func (RegenerationJobInputSnapshot) TableName() string {
	return "desktop_pet_regeneration_job_input_snapshots"
}
...
func (CandidateAcceptanceOperation) TableName() string {
	return "desktop_pet_candidate_acceptance_operations"
}
