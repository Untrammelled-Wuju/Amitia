...
const (
	SEARCH_INVALID_KIND                = "SEARCH_INVALID_KIND"
	SEARCH_KIND_UNSUPPORTED            = "SEARCH_KIND_UNSUPPORTED"
	SEARCH_SPECIALIZED_OPTIONS_INVALID = "SEARCH_SPECIALIZED_OPTIONS_INVALID"
	SEARCH_TIME_RANGE_UNSUPPORTED      = "SEARCH_TIME_RANGE_UNSUPPORTED"
	SEARCH_DOMAIN_FILTER_UNSUPPORTED   = "SEARCH_DOMAIN_FILTER_UNSUPPORTED"
