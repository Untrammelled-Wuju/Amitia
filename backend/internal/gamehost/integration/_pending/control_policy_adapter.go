...
func (a *ControlHostPolicyAdapter) AllowPluginControl(
	...
	switch state {
	case domain.RuntimeStateStopping, domain.RuntimeStateStopped,
		domain.RuntimeStateSuspending, domain.RuntimeStateSuspended,
		domain.RuntimeStateFailing, domain.RuntimeStateFailed:
