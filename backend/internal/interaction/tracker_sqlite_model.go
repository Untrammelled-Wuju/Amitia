...
type InteractionRecordModel struct {
	...
	SpaceID                string    `gorm:"column:space_id;index:idx_interaction_scope_active,priority:1;index:idx_interaction_request,priority:1"`
	...
	RecoveryDescriptorJSON string    `gorm:"column:recovery_descriptor_json"`
}
