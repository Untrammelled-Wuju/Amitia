...
export async function getAuthoritySnapshot(
  ...
  const envelope = await client.sendRequest(METHOD_AUTHORITY_SNAPSHOT, input, ...opts);
...
export async function registerControlSink(
  ...
  const envelope = await client.sendRequest(METHOD_CONTROL_REGISTER_SINK, input, ...opts);
...
export async function submitControlOutput(
  ...
  const envelope = await client.sendRequest(METHOD_CONTROL_OUTPUT, input, ...opts);
...
export async function takeoverAuthority(
  ...
  const envelope = await client.sendRequest(METHOD_CONTROL_AUTHORITY_TAKEOVER, input, ...opts);
...
export async function releaseAuthority(
  ...
  const envelope = await client.sendRequest(METHOD_CONTROL_AUTHORITY_RELEASE, input, ...opts);
