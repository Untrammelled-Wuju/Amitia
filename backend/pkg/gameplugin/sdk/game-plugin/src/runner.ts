...
import { HandlerRegistry, HelloConfiguration, RunnerConfig, ServiceHelloDescriptor, HelloResponse } from './handler';
...
export { HelloConfiguration, RunnerConfig, ServiceHelloDescriptor, HelloResponse } from './handler';
