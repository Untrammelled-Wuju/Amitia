...
describe('GameHost Permission Constants', () => {
  it('should have exactly three canonical GameHost permissions', () => {
    const perms = [PERM_GAMEHOST_CONTROL, PERM_GAMEHOST_CHANNEL_USE, PERM_GAMEHOST_HOST_API_INVOKE];
  ...
  it('should match the golden contract fixture', () => {
    ...
    const actual = [PERM_GAMEHOST_CONTROL, PERM_GAMEHOST_CHANNEL_USE, PERM_GAMEHOST_HOST_API_INVOKE];
