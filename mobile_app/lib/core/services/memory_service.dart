...
class MemoryService {
  ...
  Future<List<MemoryDto>> list() async {
    ...
    return resp.data!.map((e) => MemoryDto.fromJson(e as Map<String, dynamic>)).toList();
  }
  ...
  Future<MemoryDto?> create(Map<String, dynamic> data) async {
    ...
    return MemoryDto.fromJson(resp.data!);
  }
  ...
  Future<List<MemoryCandidateDto>> listCandidates() async {
    ...
    if (resp.data == null) return [];
    return resp.data!.map((e) => MemoryCandidateDto.fromJson(e as Map<String, dynamic>)).toList();
  }
