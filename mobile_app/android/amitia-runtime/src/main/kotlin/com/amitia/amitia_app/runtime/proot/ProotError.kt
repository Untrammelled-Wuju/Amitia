...
enum class ProotErrorCode {
    ...
    BINARY_NOT_FILE, BINARY_NOT_READABLE, ELF_INVALID, ELF_CLASS_UNSUPPORTED,
    ...
    INVALID_ENVIRONMENT, PROCESS_START_FAILED, PROCESS_EXITED, PROCESS_STOP_FAILED,
    PROCESS_TIMEOUT, SESSION_CLOSED, INTERNAL_ERROR;
