...
void main() {
  group('BackendConnectionRepository resolve', () {
    test('rejects expectedGeneration <= 0', () async {
  ...
  group('backendConnectionProvider watches runtimeSnapshotProvider', () {
    test('STOPPED does not resolve native connection', () async {
      ...
      container.read(backendConnectionRepositoryProvider);

      await container.read(backendConnectionProvider.future).catchError((_) => BackendConnectionUnavailable());
