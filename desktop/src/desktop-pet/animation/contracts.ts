...
export interface PlayActionCommand {
  ...
  // Runtime-v1 physical commands require one authoritative admission deadline.
  // Local/default renderer commands are not Runtime-v1 side effects and may omit it.
